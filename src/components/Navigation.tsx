      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="hidden h-10 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 text-sm text-slate-300 transition hover:bg-white/10 active:scale-95 sm:flex"
          >
            Translate
          </button>
          ...
          <button
            ...
            className="hidden h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-300 transition hover:bg-white/10 active:scale-95 lg:flex"
...
export function BottomNav({
  ...
  return (
    <nav className="safe-bottom fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-slate-950/95 backdrop-blur-2xl lg:static lg:border-t-0 lg:bg-transparent lg:backdrop-blur-none">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative group flex min-w-[62px] flex-col items-center gap-1 rounded-2xl px-3 py-2 text-[11px] font-medium transition-all duration-200 active:scale-90 sm:min-w-[72px] sm:text-xs ${
                active
